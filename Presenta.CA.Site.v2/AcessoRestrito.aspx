<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcessoRestrito.aspx.cs" Inherits="Presenta.CA.Site.AcessoRestrito" %>
...
<head runat="server">
    ...
    <title>Controle de Acesso 2.0 - Presenta Sistemas</title>
...
<body onresize="resizeWindow()" onload="resizeWindow()">
    ...
    <div id="dadosLogin" align="center" class="dadosLogin">
        <asp:Login 
            ...
            onloginerror="loginCA_LoginError" FailureTextStyle-ForeColor="Orange" DisplayRememberMe="false" >
