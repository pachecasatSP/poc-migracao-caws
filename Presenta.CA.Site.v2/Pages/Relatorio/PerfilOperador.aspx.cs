...
{
    public partial class PerfilOperador : PageBase
    {
        ...
        protected void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var dt = new RptPerfilOperadorModel().Listar(sistema, aplicativo);
                ...
                reportViewer.LocalReport.ReportPath = @"Pages\Relatorio\PerfilOperadorReport.rdlc";
