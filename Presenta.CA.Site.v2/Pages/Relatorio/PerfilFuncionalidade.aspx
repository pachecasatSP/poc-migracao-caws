<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="PerfilFuncionalidade.aspx.cs" Inherits="Presenta.CA.Site.Pages.Relatorio.PerfilFuncionalidade" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function configPage() {
            setGrandMenuId(3);
            setMenuHover(1);
            setPageName('Relatório - Perfil x Funcionalidade');
        }
    </script>
</asp:Content>
