<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FuncionalidadeUCR.ascx.cs" Inherits="Presenta.CA.Site.UserControls.FuncionalidadeUCR" %>
<script type="text/javascript">
    $(document).ready(function () {
        $("#FuncionalidadesGridR").jqGrid({
            ...
            datatype: 'json',
            postData: { ActionPage: 'TransportType', Action: 'FillFuncionalidadesRight', IdPerfil: '', IdSistema: '', IdAplicativo: '' },
            height: 'auto',
            ...
            rowNum: 5,
            rowList: [5, 10, 15],
            pager: '#FuncionalidadesGridRPager',
            gridview: true,
            autowidth: true,
            ...
            viewrecords: true,
            sortorder: 'asc',
            caption: 'Funcionalidades Não Associadas',
            multiselect: true,
        ...
        $("#FuncionalidadesGridR").jqGrid('navGrid', '#FuncionalidadesGridRPager', { view: true, edit: false, add: false, del: false },
            { /*Update*/ }, { /*Insert*/ }, { /*Delete*/ }, { /*View*/ width: 460 }
        );
    });
</script>
<div>
    <table id="FuncionalidadesGridR"></table>
    <div id="FuncionalidadesGridRPager"></div>
</div>