...
{
    public partial class funcionalidade_filtro : System.Web.UI.Page
    {
        public int _id = 0;
        ...
        {
            Server.Transfer("funcionalidade_cadastro.aspx?" + clsCA._PARAM_NOVO + "=1");
        }

        private void Filtrar()
        {
            clsFuncionalidade _clsPrincipal = new clsFuncionalidade();
            gvFiltro.DataSource = _clsPrincipal.RetornarLista(null, null, null, txtDescricao.Text);
