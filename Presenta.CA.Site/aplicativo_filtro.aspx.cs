...
{
    public partial class aplicativo_filtro : System.Web.UI.Page
    {
        public int _id = 0;
        ...
        {
            Server.Transfer("aplicativo_cadastro.aspx?" + clsCA._PARAM_NOVO + "=1");
        }

        private void Filtrar()
        {
            clsAplicativo _clsPrincipal = new clsAplicativo();
            gvFiltro.DataSource = _clsPrincipal.RetornarLista(null, null, txtDescricao.Text);
