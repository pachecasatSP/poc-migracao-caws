...
{
    public partial class situacao_perfil_filtro : System.Web.UI.Page
    {
        public int? stperfil;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    {
                        stperfil = Convert.ToInt32(Request.QueryString["id"]);
        ...
        {
            Server.Transfer("situacao_perfil_cadastro.aspx?" + clsCA._PARAM_NOVO + "=1");
        }
