<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="perfil_operador_associacao.aspx.cs" Inherits="Controle_Acesso.perfil_operador_cadastro" %>
    ...
    <asp:HiddenField ID="hfOperador" runat="server" />
        ...
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            ...
            <tr>
                ...
                <td><uc2:ucSituacao ID="ucOperador" runat="server" /></td>
            </tr>
            <tr>
                <td class="labeltitulo"><asp:Label ID="lblSituacao" runat="server" Text="Situação:"></asp:Label></td>
                <td><uc2:ucSituacao ID="ucSituacaoPerfilOperador" runat="server" /></td>
