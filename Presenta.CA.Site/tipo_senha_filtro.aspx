<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="tipo_senha_filtro.aspx.cs" Inherits="Controle_Acesso.tipo_senha_filtro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Tipo de Senha - Filtro" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:GridView ID="gvFiltro" runat="server" Width="745px" 
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="dstiposenha" HeaderText="Descrição" DataNavigateUrlFields="idtiposenha" DataNavigateUrlFormatString="tipo_senha_cadastro.aspx?codigo={0}" />
            <asp:HyperLinkField DataTextField="qtmaxtentativas" HeaderText="Máximo de Tentativas" DataNavigateUrlFields="idtiposenha" DataNavigateUrlFormatString="tipo_senha_cadastro.aspx?codigo={0}" />
            <asp:HyperLinkField DataTextField="qtverificacaohistorico" HeaderText="Verificação Historico" DataNavigateUrlFields="idtiposenha" DataNavigateUrlFormatString="tipo_senha_cadastro.aspx?codigo={0}" />
            <asp:HyperLinkField DataTextField="cdexpressaoregular" HeaderText="Expressão Regular" DataNavigateUrlFields="idtiposenha" DataNavigateUrlFormatString="tipo_senha_cadastro.aspx?codigo={0}" />
