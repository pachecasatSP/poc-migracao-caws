...
{
    public partial class situacao_funcionalidade_perfil_filtro : System.Web.UI.Page
    {
        public int? _stfuncionalidadeperfil;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    {
                        _stfuncionalidadeperfil = Convert.ToInt32(Request.QueryString["id"]);
        ...
        {
            Server.Transfer("situacao_funcionalidade_perfil_cadastro.aspx?" + clsCA._PARAM_NOVO + "=1");
        }
