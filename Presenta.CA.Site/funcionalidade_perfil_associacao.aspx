<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="funcionalidade_perfil_associacao.aspx.cs" Inherits="Controle_Acesso.funcionalidade_perfil_cadastro" %>
<%@ Register src="controls/ucToolbar.ascx" tagname="uctoolbar" tagprefix="uc4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hfOperador" runat="server" />
        ...
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            ...
            <tr>
                <td class="labeltitulo"><asp:Label ID="Label3" runat="server" Text="Funcionalidade:"></asp:Label></td>
                <td><uc2:ucSituacao ID="ucFuncionalidade" runat="server" /></td>

                <td class="labeltitulo"><asp:Label ID="lblIDPerfil" runat="server" Text="Perfil:"></asp:Label></td>
                <td><uc2:ucSituacao ID="ucPerfil" runat="server" /></td>
            </tr>
            <tr>
                <td class="labeltitulo"><asp:Label ID="lblSituacao" runat="server" Text="Situação:"></asp:Label></td>
                <td><uc2:ucSituacao ID="ucSituacaoFuncionalidadePerfil" runat="server" /></td>

                <td class="labeltitulo"><asp:Label ID="Label2" runat="server" Text="Data Situação:"></asp:Label></td>
                <td><asp:TextBox ID="txtDhSituacao" runat="server" Width="150px" Enabled="False"></asp:TextBox></td>
            </tr>
        ...
        <div id="divToolbar" align="right">
            <uc4:uctoolbar ID="ucCAToolbar" runat="server" />
        </div>
    </div>
</asp:Content>
