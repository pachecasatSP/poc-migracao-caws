<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="tipo_senha_validacao_filtro.aspx.cs" Inherits="Controle_Acesso.tipo_senha_validacao_filtro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Tipo de Validação de Senha - Filtro" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:GridView ID="gvFiltro" runat="server" Width="745px" 
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="dstiposenhavalidacao" HeaderText="Descrição" DataNavigateUrlFields="idtiposenhavalidacao" DataNavigateUrlFormatString="tipo_senha_validacao_cadastro.aspx?codigo={0}" />
        </Columns>
