<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="situacao_perfil_operador_cadastro.aspx.cs" Inherits="Controle_Acesso.situacao_perfil_operador_cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Situação Perfil x Operador" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
