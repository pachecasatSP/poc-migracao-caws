<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="tipo_senha_tipo_senha_validacao_associacao.aspx.cs" Inherits="Controle_Acesso.tipo_senha_tipo_senha_validacao_cadastro" %>
    ...
    <asp:HiddenField ID="hfOperador" runat="server" />
        ...
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            <tr>
                ...
                <td><uc2:ucTipos ID="ucTipoSenha" runat="server" Width="150px"></uc2:ucTipos></td>
                <td class="labeltitulo"><asp:Label ID="Label9" runat="server" Text="Validação de Tipo de Senha:"></asp:Label></td>
                <td><uc2:ucTipos ID="ucTipoSenhaValidacao" runat="server" Width="150px"></uc2:ucTipos></td>
            </tr>

            <tr>
                <td class="labeltitulo"><asp:Label ID="Label3" runat="server" Text="nuordem:"></asp:Label></td>
                <td><asp:TextBox ID="txtNuOrdem" runat="server" Width="150px"></asp:TextBox></td>
                <td class="labeltitulo"><asp:Label ID="Label4" runat="server" Text="qtmincaracteres:"></asp:Label></td>
                <td><asp:TextBox ID="txtQtMinCaracteres" runat="server" Width="150px"></asp:TextBox></td>                
            </tr>

            <tr>
                <td class="labeltitulo"><asp:Label ID="Label1" runat="server" Text="qtmaxcaracteres:"></asp:Label></td>
