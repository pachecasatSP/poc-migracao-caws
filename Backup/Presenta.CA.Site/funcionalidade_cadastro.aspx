<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="funcionalidade_cadastro.aspx.cs" Inherits="Controle_Acesso.funcionalidade_cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Funcionalidades" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:HiddenField ID="hfOperador" runat="server" />
        ...
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            ...
            <tr>
                <td class="labeltitulo"><asp:Label ID="Label1" runat="server" Text="Sistema:"></asp:Label></td>
                <td>
                    <asp:DropDownList ID="cboSistema" runat="server" Width="250px" 
                        CssClass="selectheight" AutoPostBack="True" 
                        onselectedindexchanged="cboSistema_SelectedIndexChanged1" AppendDataBoundItems="True" 
                        ></asp:DropDownList>
                </td>
                <td class="labeltitulo"><asp:Label ID="Label2" runat="server" Text="Aplicativo:"></asp:Label></td>
                <td>
                    <asp:DropDownList ID="cboAplicativo" runat="server" Width="250px" CssClass="selectheight"></asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <uc2:ucSituacao ID="ucSituacaoFuncionalidade" runat="server" />
                </td>
            </tr>

            <tr>
                <td class="labeltitulo"><asp:Label ID="lblDescricao" runat="server" Text="Descrição:"></asp:Label></td>
                <td colspan="3"><asp:TextBox ID="txtDsFuncionalidade" runat="server" MaxLength="255" 
