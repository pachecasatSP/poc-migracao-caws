<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="aplicativo_filtro.aspx.cs" Inherits="Controle_Acesso.aplicativo_filtro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Aplicativos - Filtro" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:GridView ID="gvFiltro" runat="server" Width="745px" 
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="dssistema" HeaderText="Sistema" DataNavigateUrlFields="idaplicativo" DataNavigateUrlFormatString="aplicativo_cadastro.aspx?codigo={0}" />
            <asp:HyperLinkField DataTextField="dsaplicativo" HeaderText="Descrição" DataNavigateUrlFields="idaplicativo" DataNavigateUrlFormatString="aplicativo_cadastro.aspx?codigo={0}" />
        </Columns>
