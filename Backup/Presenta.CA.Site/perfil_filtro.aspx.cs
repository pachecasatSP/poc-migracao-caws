...
{
    public partial class perfil_filtro : System.Web.UI.Page
    {
        public int _idperfil = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    {
                        _idperfil = Convert.ToInt32(Request.QueryString["id"]);
        ...
        {
            Server.Transfer("perfil_cadastro.aspx?" + clsCA._PARAM_NOVO + "=1");
        }

        private void Filtrar()
        {
            clsPerfil _clsPrincipal = new clsPerfil();
            gvFiltro.DataSource = _clsPrincipal.RetornarLista(null, txtDescricao.Text, null);
