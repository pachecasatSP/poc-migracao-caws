<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="situacao_operador_filtro.aspx.cs" Inherits="Controle_Acesso.situacao_operador_filtro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Situação do Operador - Filtro" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:GridView ID="gvFiltro" runat="server" Width="745px" 
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="dssituacaooperador" HeaderText="Descrição" DataNavigateUrlFields="stoperador" DataNavigateUrlFormatString="situacao_operador_cadastro.aspx?codigo={0}" />
        </Columns>
