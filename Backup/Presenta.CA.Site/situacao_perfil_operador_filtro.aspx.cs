...
{
    public partial class situacao_perfil_operador_filtro : System.Web.UI.Page
    {
        public int? stperfiloperador;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    {
                        stperfiloperador = Convert.ToInt32(Request.QueryString["id"]);
        ...
        {
            Server.Transfer("situacao_perfil_operador_cadastro.aspx?" + clsCA._PARAM_NOVO + "=1");
        }
