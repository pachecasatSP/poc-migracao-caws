<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="perfil_operador_associacao_02.aspx.cs" Inherits="Controle_Acesso.perfil_operador_associacao_02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Associação de Operador x Perfil" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:HiddenField ID="hfOperador" runat="server" />
        ...
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            ...
            <tr>
                <td class="labeltitulo"><asp:Label ID="Label3" runat="server" Text="Operador:  "></asp:Label>
                <asp:DropDownList ID="ddlOperador" runat="server" 
                        AutoPostBack="True" 
                        onselectedindexchanged="ddlOperador_SelectedIndexChanged" /></td>
            </tr>
                ...
                <td valign = "top">
                    <asp:GridView ID="gvPerfilIn" runat="server" Width="350px" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="idperfil" HeaderText="id" />
                            <asp:HyperLinkField DataTextField="dsperfil" HeaderText="Perfil Associado"  DataNavigateUrlFields="idoperador, idperfil" DataNavigateUrlFormatString="perfil_operador_cadastro.aspx?operador={0}&perfil={1}&page=01" />
                        </Columns>
                        <EditRowStyle BackColor="#2461BF" />
                        <FooterStyle BackColor="#236B8E" Font-Bold="True" ForeColor="White" />
                        <HeaderStyle BackColor="#236B8E" Font-Bold="True" ForeColor="White" />
