...
{
    public partial class tipo_senha_tipo_senha_validacao_filtro : System.Web.UI.Page
    {
        public int? _idtiposenha;
        public int? _idtiposenhavalidacao;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    {
                        _idtiposenha = Convert.ToInt32(Request.QueryString["id"]);
        ...
        {
            Server.Transfer("tipo_senha_tipo_senha_validacao_cadastro.aspx?" + clsCA._PARAM_NOVO + "=1");
        }

        private void Filtrar()
        {
            clsTipoSenhaTipoSenhaValidacao _clsPrincipal = new clsTipoSenhaTipoSenhaValidacao();
            gvFiltro.DataSource = _clsPrincipal.RetornarLista(null, null);
