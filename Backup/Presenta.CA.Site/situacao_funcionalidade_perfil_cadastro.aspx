<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="situacao_funcionalidade_perfil_cadastro.aspx.cs" Inherits="Controle_Acesso.situacao_funcionalidade_perfil_cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Situação Funcionalidade x Perfil" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
