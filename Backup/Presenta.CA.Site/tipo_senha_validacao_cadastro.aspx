<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="tipo_senha_validacao_cadastro.aspx.cs" Inherits="Controle_Acesso.tipo_senha_validacao_cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Tipo de Validação de Senha" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
