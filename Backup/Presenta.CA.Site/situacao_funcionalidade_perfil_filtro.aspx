<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="situacao_funcionalidade_perfil_filtro.aspx.cs" Inherits="Controle_Acesso.situacao_funcionalidade_perfil_filtro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Situação Funcionalidade x Perfil - Filtro" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:GridView ID="gvFiltro" runat="server" Width="745px" 
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="dssituacaofuncionalidadeperfil" HeaderText="Descrição" DataNavigateUrlFields="stfuncionalidadeperfil" DataNavigateUrlFormatString="situacao_funcionalidade_perfil_cadastro.aspx?codigo={0}" />
        </Columns>
