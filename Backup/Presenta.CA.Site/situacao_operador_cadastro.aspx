<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="situacao_operador_cadastro.aspx.cs" Inherits="Controle_Acesso.situacao_operador_cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Situação do Operador" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:HiddenField ID="hfOperador" runat="server" />
        ...
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            ...
            <tr>
                ...
                <td colspan="3"><asp:TextBox ID="txtDsSituacaoOperador" runat="server" MaxLength="45" 
