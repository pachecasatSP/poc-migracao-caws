...
{
    public partial class tipo_senha_validacao_filtro : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    {
                        _idtiposenhavalidacao = Convert.ToInt32(Request.QueryString["id"]);
        ...
        {
            Server.Transfer("tipo_senha_validacao_cadastro.aspx?" + clsCA._PARAM_NOVO + "=1");
        }
