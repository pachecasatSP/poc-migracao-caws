<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="funcionalidade_perfil_associacao_01.aspx.cs" Inherits="Controle_Acesso.funcionalidade_perfil_associacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Associação de Funcionalidade x Perfil" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:HiddenField ID="hfOperador" runat="server" />
        ...
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            ...
            <tr>
                <td class="labeltitulo"><asp:Label ID="Label3" runat="server" Text="Funcionalidade:  "></asp:Label>
                <asp:DropDownList ID="ddlFuncionalidade" runat="server" 
                        onselectedindexchanged="ddlFuncionalidade_SelectedIndexChanged" AutoPostBack="True" /></td>
            </tr>

            <tr>
                
                <td valign = "top">
                    <asp:GridView ID="gvPerfilOut" runat="server" Width="350px" 
                        ...
                        onrowcommand="gvPerfilOut_RowCommand" >
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="dsperfil" HeaderText="Perfil Não Associado" />
                ...
                <td valign = "top">
                    <asp:GridView ID="gvPerfilIn" runat="server" Width="350px" 
                        AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" 
                        BorderStyle="None" BorderWidth="1px" CellPadding="3" ForeColor="Black" 
                        GridLines="Vertical" AllowPaging="True" CellSpacing="1" PageSize="15" 
                        onrowcommand="gvPerfilIn_RowCommand" >
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:ButtonField ButtonType="Button" HeaderText="Remover" CommandName="Select" Text="<--" />
                            <asp:BoundField DataField="idperfil" HeaderText="id" />
                            <asp:HyperLinkField DataTextField="dsperfil" HeaderText="Perfil Associado"  DataNavigateUrlFields="idfuncionalidade, idperfil" DataNavigateUrlFormatString="funcionalidade_perfil_cadastro.aspx?funcionalidade={0}&perfil={1}&page=01" />
                        </Columns>
                        <EditRowStyle BackColor="#2461BF" />
                        <FooterStyle BackColor="#236B8E" Font-Bold="True" ForeColor="White" />
                        <HeaderStyle BackColor="#236B8E" Font-Bold="True" ForeColor="White" />
