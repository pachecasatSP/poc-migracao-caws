<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="sistema_filtro.aspx.cs" Inherits="Controle_Acesso.sistema_filtro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Sistemas - Filtro" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:GridView ID="gvFiltro" runat="server" Width="745px" 
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="dssistema" HeaderText="Descrição" DataNavigateUrlFields="idsistema" DataNavigateUrlFormatString="sistema_cadastro.aspx?codigo={0}" />
        </Columns>
