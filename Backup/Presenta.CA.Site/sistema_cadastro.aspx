<%@ Page Title="" Language="C#" MasterPageFile="~/controle_acesso.master" AutoEventWireup="true" CodeBehind="sistema_cadastro.aspx.cs" Inherits="Controle_Acesso.sistema_cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblTitulo" runat="server" Text="..:: Cadastro de Sistemas" class="tituloform" Width="735px"></asp:Label>
    <br /><br />
    ...
    <asp:HiddenField ID="hfOperador" runat="server" />    
        ...
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            <tr>
                <td class="labeltitulo"><asp:Label ID="Label2" runat="server" Text="Sistema:"></asp:Label></td>
                <td colspan="3"><asp:TextBox ID="txtDsSistema" runat="server" MaxLength="45" Width="100%" ></asp:TextBox></td>
            </tr>
